              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bienvenido a KONECTA</h1>
                  </div>
                  @yield('content')
                  </div>
                  ...
                  <div class="container">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group has-error has-feedback">
                            <input type="text" name="nomusu" class="form-control form-control-user" id="username" placeholder="Ingrese su nombre de usuario..." required>
